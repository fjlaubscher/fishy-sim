...
/***/ function(module, exports, __webpack_require__) {
	...
	var Animal = function () {
	  ...
	  _createClass(Animal, [{
	    ...
	    key: 'move',
	    value: function move() {
	      var direction = new _Rectangle2.default(Math.cos(this.rotationAngle()), Math.sin(this.rotationAngle()));
